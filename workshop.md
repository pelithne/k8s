...
```` 
az aks create --resource-group techdays --name <Your AKS name> --disable-rbac --generate-ssh-keys --attach-acr <your unique ACR name> --load-balancer-sku basic --node-count 1
````
